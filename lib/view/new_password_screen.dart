        ...
        child:  Padding(
          ...
          child: Column(
            children: [
              ...
              TextFormFieldWidget(text: 'New Password', keyboardType: TextInputType.emailAddress, controller: _passwordController,),

              const SizedBox(height: 20,),

              TextFormFieldWidget(text: 'Confirm Your Password', keyboardType: TextInputType.emailAddress, controller: _confirmController,),
